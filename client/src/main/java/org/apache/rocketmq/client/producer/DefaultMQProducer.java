...
public class DefaultMQProducer extends ClientConfig implements MQProducer {
     ...
     *
     * 生产者所属组,消息服务器在回查事务状态时会随机选择该组中的任何一个生产者发送事务回查请求
     *
     ...
     *
     * 允许发送最大消息长度默认为4M,最大为2^32 -1 约等于 4G
     */
     ...
     * use this method.
     *
     * @param key accesskey 目前无实际作用
     * @param newTopic topic name 主题名称
     * @param queueNum topic's queue number 主题队列数量
     * @param topicSysFlag topic system flag 主题系统标签 默认 0
     * @throws MQClientException if there is any client error.
     */
    @Deprecated
    @Override
